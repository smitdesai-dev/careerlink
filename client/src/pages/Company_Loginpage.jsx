...
//         navigate("/company_otp_verification", {
//           state: { email: formvalues.email },
//         }); // Redirect to otp verification page
//       } catch (error) {
//         if (error.response && error.response.status === 400) {
//           // Display alert for existing user
//           alert(error.response.data.message);
//           navigate("/company_register"); // Redirect to login page
...
//       errors.password =
//         "Password must contain one digit, one lowercase, one uppercase, one special character (underscore), and be 8-16 characters long";
//     }
...
//               <h4 id="login-link">
//                 Don't have an account? Company{" "}
//                 <a href="/company_register">Signup</a>
//               </h4>
//             </form>
//           </div>
//         </div>
