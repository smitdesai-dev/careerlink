...
//       axios
//         .get(
//           `http://localhost:5001/api/company_profile?email=${emailFromCookie}`, {
//             params: {
//               sessionid:sessionid
//             }
//           }
...
//     } catch (error) {
//       setMessage("Error updating company profile!");
...
//       <div id="profile-box">
//         <div id="profile-left">
//           <div id="profile-edit" onClick={() => setIsReadOnly(false)}>
...
//                 value={formValues.establishedDate}
